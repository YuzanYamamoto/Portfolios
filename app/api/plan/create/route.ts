  ...
  try {
    const { text } = await generateText({
      ...
      prompt: `
        ...
        3. **総合情報**: ドライブ全体の概要
        4. **プラン全体のSpotifyプレイリスト**: ドライブプラン全体の雰囲気に合う楽曲リストを生成してください。
            ...
            "tracks": [
              {
                "title": "楽曲名",
                "artist": "アーティスト名",
                "reason": "この楽曲を選んだ理由（ドライブのどの場面に合うか）"
              }
            ]
          }
        }
        ...
        - **overall_spotify_playlist.url**: "https://open.spotify.com/embed/playlist/placeholder" を設定してください（後でSpotify APIで実際のプレイリストを作成します）
